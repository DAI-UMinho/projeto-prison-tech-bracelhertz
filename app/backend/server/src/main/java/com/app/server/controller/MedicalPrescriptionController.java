...
public class MedicalPrescriptionController {
	...
	/*
	 * @GetMapping("/prescription") public List<MedicalPrescription>
	 * listPrescription(){ return medicalPrescriptionRepository.findAll(); }
	 */

	/*
	 * @GetMapping("/prescription/{prescriptionId}") public MedicalPrescription
	 * listPrescription(@PathVariable(value="prescriptionId") long prescriptionId){
	...
	public ResponseEntity<ApiResponse> savePrescription(@Valid @RequestBody MedicalPrescription prescription,
		...
		try {
			...
			return new ResponseEntity<ApiResponse>(
					new ApiResponse(true, "Prisoner created", prescription.getPrescriptionId()), HttpStatus.CREATED);
		} catch (Exception e) {

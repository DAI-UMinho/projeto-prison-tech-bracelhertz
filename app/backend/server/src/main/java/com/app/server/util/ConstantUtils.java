...
public class ConstantUtils {
	...
	// Allow only letters, letters with special characters, numbers and special
	// characters (",", "º", " ")
	public static final String ADDRESS_PATTERN = "[a-zA-Z0-9-A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ,º ]+";
